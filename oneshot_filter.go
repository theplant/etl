...
// MarshalOneShotFilter encodes a source-defined filter struct into the opaque
// form carried by ExtractRequest.OneShotFilter. The framework never
// interprets the content; each Source defines its own filter schema.
...
// UnmarshalOneShotFilter decodes ExtractRequest.OneShotFilter into the
// source-defined filter struct F. Unknown fields and trailing data are
