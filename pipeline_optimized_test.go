...
// targeted sync (see OneShotPipeline). It travels opaquely inside
// ExtractRequest.OneShotFilter; only this Source knows its schema. Extend it
// with new fields (emails, time range, ...) to support more targeting
// criteria.
